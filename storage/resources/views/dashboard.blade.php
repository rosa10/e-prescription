...
{{-- @endforeach --}}
  ...
  <option value="{{$obatalkes_m->obatalkes_nama}}">stok: {{$obatalkes_m->stok}}</option>
    @endforeach
</datalist>
    </div>
  </div>
...
<datalist id="signa">
  ...
  <option value="{{$signa_m->signa_nama}}">
    @endforeach
</datalist>
    </div>
  </div>
<div class="mb-3 row">
    ...
    <div class="col-sm-10">
      ...
      {{-- <?php if ($jumlah < 20) {echo "Have a good day!";} else {echo "Have a good night!";} ?> --}}
      >
    </div>
  </div>
